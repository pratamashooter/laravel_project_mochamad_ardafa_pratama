                                    ...
                                    <div class="input-group input-group-merge">
                                        <select class="form-select" name="kategori_id" style="@error('kategori_id') border-color: red; @enderror">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" {{ $category->id == old('kategori_id', $product->kategori_id) ? 'selected' : '' }}>{{ $category->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <textarea id="basic-icon-default-message"
                                            ...
                                            style="@error('deskripsi') border-color: red; @enderror">{{ old('deskripsi', $product->deskripsi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
